/**
 * @file test.cpp
 * @author Part 1 team Po Yu and Pavan
 * @brief 
 * @version 0.1
 * @date 2022-10-05
 * 
...
TEST(unit_compute, case1) { EXPECT_DOUBLE_EQ(pid.compute(1.0, 1.0), 0.0); }

TEST(unit_compute, case2) { EXPECT_DOUBLE_EQ(pid2.compute(1.0, 2.0), -0.1); }
